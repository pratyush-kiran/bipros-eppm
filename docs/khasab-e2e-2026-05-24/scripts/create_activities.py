...
DPRS = json.load(open("/tmp/khasab/parsed-pre-resolve.json")) if False else json.load(open("/tmp/khasab-dpr-parsed.json"))
...
with open("/tmp/khasab/activity-ids.json", "w") as f:
