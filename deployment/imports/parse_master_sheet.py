...
XLSX = os.environ.get("BIPROS_EXCEL_DIR", "./data/khasab-excel") + "/dbs-master.xlsx"
OUT_MASTER = os.environ.get("BIPROS_WORK_DIR", "/tmp/khasab") + "/activity-master.json"
...
with open(os.environ.get("BIPROS_WORK_DIR", "/tmp/khasab") + "/activity-master-normalized.json", "w") as f:
