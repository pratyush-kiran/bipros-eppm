...
public class DbsController {
    ...
    public ResponseEntity<ApiResponse<List<DbsSupervisorSummaryDto>>> listSupervisors(
        ...
        // the period scope. Previously the roster was empty whenever the focal date had no
        // DPRs but the surrounding week/month did, hiding all data on the Supervisor tab.
