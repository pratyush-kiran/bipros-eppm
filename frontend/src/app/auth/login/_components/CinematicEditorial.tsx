...
export function CinematicEditorial() {
  return (
    <div className="relative z-10 flex h-full flex-col justify-end px-6 pb-10 pt-16 lg:px-14 lg:pb-16 lg:pt-24">
      <div className="cn-rise cn-d1 mb-5 inline-flex items-center gap-2 text-[10.5px] uppercase tracking-[0.24em] text-[#B0C6FF]">
        <span aria-hidden className="inline-block h-px w-7 bg-[#B0C6FF]" />
      ...
      >
        ...
        <span className="block italic font-normal text-[#B0C6FF]">a single source of truth.</span>
      </h1>
      ...
      <figure className="cn-rise cn-d5 mt-8 hidden max-w-lg border-l-2 border-[#B0C6FF]/50 pl-5 lg:block">
