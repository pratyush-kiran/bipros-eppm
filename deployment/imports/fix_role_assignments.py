...
# Dynamic lookup — works in any DB. Falls back to the legacy dev UUID only if
# the lookup somehow returns nothing.
_rows = sql("SELECT id::text FROM resource.resource_types WHERE code='EQUIPMENT' LIMIT 1") or [["709f41b3-4aa3-462e-9fc9-66deff8da325"]]
EQUIP_TYPE_ID = _rows[0][0]
import re as _re
def _slug(s, n=40):
