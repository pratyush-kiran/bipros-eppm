...
MASTER = json.load(open(os.environ.get("BIPROS_WORK_DIR", "/tmp/khasab") + "/activity-master-normalized.json"))
...
with open(os.environ.get("BIPROS_WORK_DIR", "/tmp/khasab") + "/activity-plan.json", "w") as f:
